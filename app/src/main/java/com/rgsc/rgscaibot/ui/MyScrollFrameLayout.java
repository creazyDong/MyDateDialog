...
public class MyScrollFrameLayout  extends FrameLayout {
    ...
    public MyScrollFrameLayout(@NonNull Context context) {
        this(context, null, 0);
    }

    public MyScrollFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyScrollFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
